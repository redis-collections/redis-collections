# -*- coding: utf-8 -*-
#
# Redis Collections documentation build configuration file, created by
...
htmlhelp_basename = 'RedisCollectionsdoc'
...
latex_documents = [
    (
        'index',
        'RedisCollections.tex',
        u'Redis Collections Documentation',
        u'Honza Javorek',
        'manual',
    ),
]
